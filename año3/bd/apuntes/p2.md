...
### 1. ¿Qué son los rastreadores web y qué desafíos enfrentan?
...
### 2. ¿Cómo funciona la indexación para los motores de búsqueda web?
...
### 3. ¿Cómo manejan los motores de búsqueda el problema de la relevancia de los documentos en la web?
...
### 4. ¿Qué es PageRank y cómo mide la popularidad de un sitio web?
...
-   Con probabilidad $\delta$, salta a otra página aleatoria.
...
### 5. ¿Cómo puede el texto en los enlaces de anclaje mejorar la relevancia de los resultados de búsqueda?
...
El texto de anclaje proporciona pistas valiosas sobre el tema de la página enlazada. Al tratar el texto de anclaje como parte del contenido de la página de destino, los cálculos de TF-IDF pueden tenerlo en cuenta. Alternativamente, la popularidad puede calcularse utilizando solo las páginas que contienen los términos de consulta en su texto de anclaje.

### 6. ¿Cuál es el enfoque de Google para la búsqueda en la web?
...
### 7. ¿Qué información se incluye típicamente en un resultado de búsqueda de Google?
...
### 8. Más allá de los enlaces básicos, ¿qué otras características ofrece Google en los resultados de búsqueda?
...
### Temas Clave
#### Desafíos y Soluciones en la Recuperación de Información Web \
...
#### Relevancia y Popularidad en la Búsqueda Web \
...
Esta sección introduce la ingeniería de prompts como el arte de diseñar y optimizar prompts para Modelos de Lenguaje (LMs). Se enfatiza la importancia de refinar los prompts para lograr resultados deseados de manera eficiente y precisa.
...
Guían al modelo para generar un proceso de razonamiento paso a paso, particularmente útil para problemas lógicos o matemáticos. CoT se puede lograr a través de instrucciones directas o proporcionando ejemplos.

### Entrenando LMs para Tareas Específicas
#### Prompts de cero disparos \
No se proporcionan ejemplos, confiando en el conocimiento preexistente del modelo.

#### Prompts de un disparo \
...
## Ideas/Datos Más Importantes
### Tokens como Factor de Costo
...
### Naturaleza Probabilística del LM
...
## Preguntas Frecuentes: Ingeniería de Prompts para IA Basada en Texto
...
### 2. ¿Cómo procesan los modelos de IA los prompts?
#### Tokenización \
...
### 3. ¿Cuáles son los elementos clave de un prompt?
#### Acción \
...
### 4. ¿Cómo puedo controlar la creatividad y la predictibilidad de la salida de la IA?
#### Parámetros \
Parámetros como "temperatura" y "TopP" influyen en la salida de la IA.

### 5. ¿Qué es el prompting de Cadena de Pensamiento (CoT) y por qué es útil?
#### Definición \
...
### 6. ¿Cuáles son los diferentes tipos de prompts utilizados para entrenar una IA?
#### Prompt de cero disparos \
La IA intenta realizar una tarea sin ejemplos.

#### Prompt de un disparo \
Se proporciona un solo ejemplo para guiar la respuesta de la IA.

#### Prompt de pocos disparos \
Se dan varios ejemplos para ayudar a la IA a aprender patrones.

### 7. ¿Cuáles son algunas mejores prácticas para escribir prompts efectivos?
#### Especificidad \
...
### 8. ¿Cómo puedo evitar que la IA "alucine" o invente información?
#### Instrucción \
